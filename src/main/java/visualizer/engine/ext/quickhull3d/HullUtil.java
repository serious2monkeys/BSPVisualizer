 ...
 */
package visualizer.engine.ext.quickhull3d;


import visualizer.engine.CSG;
import visualizer.engine.Polygon;
import visualizer.engine.PropertyStorage;
...
public class HullUtil {
    ...
    public static CSG hull(List<visualizer.engine.Vector3d> points, PropertyStorage storage) {
        ...
        List<visualizer.engine.Vector3d> vertices = new ArrayList<>();
    ...
    public static CSG hull(CSG csg, PropertyStorage storage) {
        ...
        List<visualizer.engine.Vector3d> points = new ArrayList<>(csg.getPolygons().size() * 3);
